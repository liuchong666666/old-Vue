...
//按需加载
// const Foo = resolve => require(['./Foo.vue'], resolve)  vue.js官方文档懒加载，貌似新版本的自动就实现了
...
import NewsDetail from './components/news/newsDeatil.vue';
...
Vue.component('navBar', NavBar); //声明全局组件，使用最好以nav-bar
Vue.component('comment', Comment); //评论组件,使用要以comment，并且接收参数cid
...
let router = new VueRouter({
  linkActiveClass: 'mui-active', //改变路由激活时的样式
